...
async def ask_question_with_video_async(client, video_path, question_text, options, task_info, subtitle_text=None):
    """
    ...
    if subtitle_text:
        prompt = (
            "Select the best answer to the following multiple-choice question based on the video and its subtitles.\n"
